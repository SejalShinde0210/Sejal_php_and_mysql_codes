...
$sql="UPDATE biomedical SET engineer = '$engineer_assign' ,administrator_status='$assign',admin_assign_time='$date'WHERE complaint_id = $complaint_id";
$query_one = mysqli_query($connect, $sql);



$sql_get_dates = "SELECT admin_assign_time, time_date FROM biomedical WHERE complaint_id = $complaint_id";
...
if ($result_dates && mysqli_num_rows($result_dates) > 0) {
    ...
    $sql_update_t1 = "UPDATE biomedical SET T1 = '$time_difference' WHERE complaint_id = $complaint_id";
