...
$sql = $sql="SELECT it.ph_no,it.prob,it.sub_prob,it.priority,it.photo,it.descrp,it.floor,it.complaint_id,it.engine_status,logg.department,logg.extension,logg.department,it.emp_id FROM logg INNER JOIN it ON it.emp_id=logg.emp_id WHERE engineer='$emp_id'";
$db_data = array();
